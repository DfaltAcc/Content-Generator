 ...
 *
 * Client component that handles the settings page logic.
 * Extracted from page.tsx so that useSearchParams() can be wrapped
 * in a <Suspense> boundary (required by Next.js 15/16).
 */
